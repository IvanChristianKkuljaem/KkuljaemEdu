  ...
  return (
    ...
    >
      {portfolioSlider.map((singleSlider) => (
        <SwiperSlide className="single-pf" key={singleSlider.id} style={{ borderRadius: '24px' }}>
          <Image src={singleSlider.img} alt="#" width={320} height={292} style={{ minWidth: '320px', minHeight: '292px', borderRadius: '24px' }} />
