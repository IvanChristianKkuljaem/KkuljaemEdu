...
export default function ColorPlate() {
  const colors = ['#1A76D1', '#2196F3', '#32B87D', '#FE754A', '#F82F56', '#01B2B7', '#6C5CE7', '#85BA46', '#273C75', '#FD7272', '#BADC58', '#44CE6F'];
  ...
  return (
    <>
      <div className={`color-plate  ${optionsOpen ? 'active' : ''}`}>
        ...
        <h4>Kkuljaem Education</h4>
        <p>Here is some awesome color&apos;s available on Kkuljaem Education.</p>
